...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _core=require("@cycle/core"),_dom=require("@cycle/dom"),_cycleRestart=require("cycle-restart"),_isolate=require("@cycle/isolate"),_isolate2=_interopRequireDefault(_isolate),app=require("./src/app")["default"],drivers={DOM:(0,_cycleRestart.restartable)((0,_dom.makeDOMDriver)(".app"),{pauseSinksWhileReplaying:!1})},_run=(0,_core.run)(app,drivers),sinks=_run.sinks,sources=_run.sources;module.hot&&module.hot.accept("./src/app",function(){app=require("./src/app")["default"],(0,_cycleRestart.restart)(app,drivers,{sinks:sinks,sources:sources},_isolate2["default"])});

},{"./src/app":66,"@cycle/core":2,"@cycle/dom":3,"@cycle/isolate":11,"cycle-restart":15}],2:[function(require,module,exports){
"use strict";
...
},{"rx":27}],3:[function(require,module,exports){
"use strict";
...
},{"./fromevent":4,"./transposition":8,"./virtual-hyperscript":10,"matches-selector":25,"rx":27,"vdom-parser":32,"virtual-dom/diff":39,"virtual-dom/patch":40}],7:[function(require,module,exports){
"use strict";
...
},{"./transposition":8,"rx":27,"vdom-to-html":36}],8:[function(require,module,exports){
"use strict";
...
},{"rx":27,"virtual-dom/vnode/vnode":59}],9:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
// END Cycle.js-specific code <<<<<<<<<<
},{"./virtual-hyperscript":10,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":47,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":51,"x-is-array":64}],10:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
},{"./restartable":16,"@cycle/core":2,"rx":27}],16:[function(require,module,exports){
'use strict';
...
},{"rx":27}],17:[function(require,module,exports){
/*!
 * escape-html
...
},{"sentence-case":28}],27:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":29,"./vendor/non-word-regexp":30,"./vendor/trailing-digit-regexp":31,"lower-case":24}],29:[function(require,module,exports){
...
},{"./property-config":37,"escape-html":17}],36:[function(require,module,exports){
var escape = require('escape-html');
...
},{"../vnode/is-vhook.js":54,"is-object":23}],42:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":52,"../vnode/is-vnode.js":55,"../vnode/is-vtext.js":56,"../vnode/is-widget.js":57,"./apply-properties":41,"global/document":19}],43:[function(require,module,exports){
...
},{"./create-element":42,"./dom-index":43,"./patch-op":44,"global/document":19,"x-is-array":64}],46:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":18}],49:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":54,"is-object":23}],63:[function(require,module,exports){
var isArray = require("x-is-array")
...
"use strict";function view(e){return(0,_dom.div)(".configsettings",[(0,_dom.div)(".from",[(0,_dom.span)(".label","config settings"),(0,_dom.textarea)(".config")]),(0,_dom.div)(".deployprefix",[(0,_dom.span)(".label","deploy prefix"),(0,_dom.input)(".deployprefix")]),(0,_dom.div)(".results",[(0,_dom.h2)(".label","Results"),(0,_dom.div)(".tocsdef",[(0,_dom.span)(".label","csdef settings"),(0,_dom.textarea)(".csdef",{value:e.csdef})]),(0,_dom.div)(".tocscfg",[(0,_dom.span)(".label","cscfg settings"),(0,_dom.textarea)(".cscfg",{value:e.cscfg})]),(0,_dom.div)(".todeploymap",[(0,_dom.span)(".label","deploy settings map"),(0,_dom.textarea)(".deploymap",{value:e.deploymap})]),(0,_dom.div)(".todeploy",[(0,_dom.span)(".label","deploy settings"),(0,_dom.textarea)(".deploy",{value:e.deploy})]),(0,_dom.div)(".todeployvalues",[(0,_dom.span)(".label","deploy settings w/values"),(0,_dom.textarea)(".deployvalues",{value:e.deployvalues})])])])}function toArray(e){return e?Array.prototype.slice.call(e):[]}function parseXml(e){var t=new DOMParser,n=t.parseFromString("<rootforparse>"+e+"</rootforparse>","text/xml");return toArray(n.getElementsByTagName("rootforparse")[0].childNodes).map(function(e){return{tag:e.nodeName,value:e.nodeValue,attributes:toArray(e.attributes).map(function(e){return{name:e.name,value:e.value}})}})}function App(e){var t=e.DOM,n=t.select(".config").events("input").map(function(e){return e.target.value}),r=t.select(".deployprefix").events("input").map(function(e){return e.target.value}),a=n.startWith("").combineLatest(r.startWith(""),function(e,t){return{input:e,prefix:t}}).map(function(e){return{from:parseXml(e.input),prefix:e.prefix}}).scan(function(e,t){var n=t.from;return e.csdef=n.filter(function(e){return"add"===e.tag}).map(function(e){return"<Setting "+e.attributes.filter(function(e){return"key"===e.name}).map(function(e){return'name="'+e.value+'"'}).join(" ")+" />"}).join("\n"),e.cscfg=n.filter(function(e){return"add"===e.tag}).map(function(e){return"<Setting "+e.attributes.filter(function(e){return"key"===e.name}).map(function(e){return'name="'+e.value+'"'}).concat(e.attributes.filter(function(e){return"value"===e.name}).map(function(e){return'value="'+e.value+'"'})).join(" ")+" />"}).join("\n"),e.deploymap=n.filter(function(e){return"add"===e.tag}).map(function(e){var n=e.attributes.filter(function(e){return"key"===e.name}).map(function(e){return e.value}).join("");return'<Setting Name="'+n+'">$('+t.prefix+n.split(".").pop(-1)+")</Setting>"}).join("\n"),e.deploy=n.filter(function(e){return"add"===e.tag}).map(function(e){var n=e.attributes.filter(function(e){return"key"===e.name}).map(function(e){return e.value}).join(""),r=t.prefix+n.split(".").pop(-1);return'<Setting Name="'+r+'"></Setting>'}).join("\n"),e.deployvalues=n.filter(function(e){return"add"===e.tag}).map(function(e){var n=e.attributes.filter(function(e){return"key"===e.name}).map(function(e){return e.value}).join(""),r=e.attributes.filter(function(e){return"value"===e.name}).map(function(e){return e.value}).join(""),a=t.prefix+n.split(".").pop(-1);return'<Setting Name="'+a+'">'+r+"</Setting>"}).join("\n"),e},{csdef:"",cscfg:"",deploy:"",deploymap:"",deployvalues:""});return{DOM:a.map(view)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=App;var _dom=require("@cycle/dom"),_rx=require("rx");
