...
"use strict";function view(o){return(0,_dom.div)(".form-horizontal .configsettings",[(0,_dom.h1)("Azure Settings"),(0,_dom.div)("take the settings from a web.config and translate them to csdef, cscfg, and deployment xml"),(0,_dom.div)(".inputs",[(0,_dom.h2)(null,"Inputs"),(0,_dom.div)(".form-group .from",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"config settings"),(0,_dom.div)(".col-sm-10",(0,_dom.textarea)(".form-control .config",{id:"config",placeholder:'<add key="My.Application.Location" value="http://localhost:8000"/>'}))]),(0,_dom.div)(".form-group .deployprefix",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"deploy prefix"),(0,_dom.div)(".col-sm-10",(0,_dom.input)(".form-control .deployprefix",{id:"config",placeholder:"MyApplication"}))]),(0,_dom.div)(".form-group .deploysuffix",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"deploy suffix"),(0,_dom.div)(".col-sm-10",(0,_dom.input)(".form-control .deploysuffix",{id:"config"}))])]),(0,_dom.div)(".results",[(0,_dom.h2)(null,"Results"),(0,_dom.div)(".form-group .tocsdef",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"csdef settings"),(0,_dom.div)(".col-sm-10",(0,_dom.textarea)(".form-control .csdef",{id:"config",value:o.csdef}))]),(0,_dom.div)(".form-group .tocscfg",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"cscfg settings"),(0,_dom.div)(".col-sm-10",(0,_dom.textarea)(".form-control .cscfg",{id:"config",value:o.cscfg}))]),(0,_dom.div)(".form-group .todeploymap",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"deploy settings map"),(0,_dom.div)(".col-sm-10",(0,_dom.textarea)(".form-control .deploymap",{id:"config",value:o.deploymap}))]),(0,_dom.div)(".form-group .todeploy",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"deploy settings"),(0,_dom.div)(".col-sm-10",(0,_dom.textarea)(".form-control .deploy",{id:"config",value:o.deploy}))]),(0,_dom.div)(".form-group .todeployvalues",[(0,_dom.label)(".col-sm-2 .control-label",{htmlFor:"config"},"deploy settings w/values"),(0,_dom.div)(".col-sm-10",(0,_dom.textarea)(".form-control .deployvalues",{id:"config",value:o.deployvalues}))])])])}function toArray(o){return o?Array.prototype.slice.call(o):[]}function parseXml(o){var t=new DOMParser,e=t.parseFromString("<rootforparse>"+o+"</rootforparse>","text/xml");return toArray(e.getElementsByTagName("rootforparse")[0].childNodes).map(function(o){return{tag:o.nodeName,value:o.nodeValue,attributes:toArray(o.attributes).map(function(o){return{name:o.name,value:o.value}})}})}function App(o){var t=o.DOM,e=t.select(".config").events("input").map(function(o){return o.target.value}),n=t.select(".deployprefix").events("input").map(function(o){return o.target.value}),r=t.select(".deploysuffix").events("input").map(function(o){return o.target.value}),i=e.startWith("").combineLatest(n.startWith(""),r.startWith(""),function(o,t,e){return{input:o,prefix:t,suffix:e}}).map(function(o){return{from:parseXml(o.input),prefix:o.prefix,suffix:o.suffix}}).scan(function(o,t){var e=t.from;return o.csdef=e.filter(function(o){return"add"===o.tag}).map(function(o){return"<Setting "+o.attributes.filter(function(o){return"key"===o.name}).map(function(o){return'name="'+o.value+'"'}).join(" ")+" />"}).join("\n"),o.cscfg=e.filter(function(o){return"add"===o.tag}).map(function(o){return"<Setting "+o.attributes.filter(function(o){return"key"===o.name}).map(function(o){return'name="'+o.value+'"'}).concat(o.attributes.filter(function(o){return"value"===o.name}).map(function(o){return'value="'+o.value+'"'})).join(" ")+" />"}).join("\n"),o.deploymap=e.filter(function(o){return"add"===o.tag}).map(function(o){var e=o.attributes.filter(function(o){return"key"===o.name}).map(function(o){return o.value}).join("");return'<Setting Name="'+e+'">$('+t.prefix+e.split(".").pop(-1)+t.suffix+")</Setting>"}).join("\n"),o.deploy=e.filter(function(o){return"add"===o.tag}).map(function(o){var e=o.attributes.filter(function(o){return"key"===o.name}).map(function(o){return o.value}).join(""),n=t.prefix+e.split(".").pop(-1)+t.suffix;return'<Setting Name="'+n+'"></Setting>'}).join("\n"),o.deployvalues=e.filter(function(o){return"add"===o.tag}).map(function(o){var e=o.attributes.filter(function(o){return"key"===o.name}).map(function(o){return o.value}).join(""),n=o.attributes.filter(function(o){return"value"===o.name}).map(function(o){return o.value}).join(""),r=t.prefix+e.split(".").pop(-1)+t.suffix;return'<Setting Name="'+r+'">'+n+"</Setting>"}).join("\n"),o},{csdef:"",cscfg:"",deploy:"",deploymap:"",deployvalues:""});return{DOM:i.map(view)}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=App;var _dom=require("@cycle/dom"),_rx=require("rx");
